...
const titles={'/':'Main River Cottage','/planner':'Weekly Planner','/daily':'Daily Planner','/recipes':'Recipes','/groceries':'Groceries','/guests':'Guests','/smoker':'Smoker HQ','/hosting':'Hosting','/settings':'Settings'}
