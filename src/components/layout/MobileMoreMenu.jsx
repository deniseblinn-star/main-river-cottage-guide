...
import { Utensils, BookOpen, Users, ClipboardCheck, Settings, X, CalendarHeart, Images } from 'lucide-react'
const items=[['/daily',Utensils,'Daily Planner','Today by meal'],['/recipes',BookOpen,'Recipes','Ingredients and steps'],['/guests',Users,'Guests','Who is here'],['/events',CalendarHeart,'Events','Reusable yearly events'],['/photos',Images,'Photos','Shared family gallery'],['/hosting',ClipboardCheck,'Hosting','Checklists'],['/settings',Settings,'Settings','App and data']]
