...
import { Home, CalendarDays, Utensils, BookOpen, ShoppingCart, Users, Flame, ClipboardCheck, Settings, TreePine, CalendarHeart, Images, BedDouble, MapPinned } from 'lucide-react'
const nav=[['/',Home,'Dashboard'],['/gathering',MapPinned,'Overall Events'],['/people',Users,'People & Attendance'],['/planner',CalendarDays,'Meal Planner'],['/accommodations',BedDouble,'Beds'],['/recipes',BookOpen,'Recipes'],['/groceries',ShoppingCart,'Groceries'],['/events',CalendarHeart,'Activities'],['/photos',Images,'Photos'],['/smoker',Flame,'Smoker HQ'],['/hosting',ClipboardCheck,'Hosting'],['/settings',Settings,'Settings']]
