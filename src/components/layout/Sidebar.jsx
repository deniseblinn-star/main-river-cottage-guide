...
import { Home, CalendarDays, Utensils, BookOpen, Calculator, ShoppingCart, Users, Flame, ClipboardCheck, Settings, TreePine, CalendarHeart, Images } from 'lucide-react'
const nav=[['/',Home,'Dashboard'],['/planner',CalendarDays,'Weekly Planner'],['/daily',Utensils,'Daily Planner'],['/recipes',BookOpen,'Recipes'],['/recipe-engine',Calculator,'Recipe Engine'],['/groceries',ShoppingCart,'Groceries'],['/guests',Users,'Guests'],['/events',CalendarHeart,'Events'],['/photos',Images,'Photos'],['/smoker',Flame,'Smoker HQ'],['/hosting',ClipboardCheck,'Hosting'],['/settings',Settings,'Settings']]
