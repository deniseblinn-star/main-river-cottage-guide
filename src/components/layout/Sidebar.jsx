...
import { Home, CalendarDays, Utensils, BookOpen, ShoppingCart, Users, Flame, ClipboardCheck, Settings, TreePine } from 'lucide-react'
const nav=[['/',Home,'Dashboard'],['/planner',CalendarDays,'Weekly Planner'],['/daily',Utensils,'Daily Planner'],['/recipes',BookOpen,'Recipes'],['/groceries',ShoppingCart,'Groceries'],['/guests',Users,'Guests'],['/smoker',Flame,'Smoker HQ'],['/hosting',ClipboardCheck,'Hosting'],['/settings',Settings,'Settings']]
