...
const nav=[['/',Home,'Dashboard'],['/overall-events',CalendarRange,'Overall Events'],['/people',Users,'People & Attendance'],['/planner',CalendarDays,'Meal Planner'],['/daily',Utensils,'Daily Meals'],['/recipes',BookOpen,'Recipes'],['/groceries',ShoppingCart,'Groceries'],['/accommodations',BedDouble,'Accommodations'],['/events',CalendarHeart,'Activities'],['/photos',Images,'Photos'],['/smoker',Flame,'Smoker HQ'],['/settings',Settings,'Settings']]
