...
const nav=[['/',Home,'Dashboard'],['/overall-events',CalendarRange,'Overall Events'],['/people',Users,'People & Attendance'],['/planner',CalendarDays,'Weekly Planner'],['/daily',Utensils,'Daily Planner'],['/recipes',BookOpen,'Recipes'],['/groceries',ShoppingCart,'Groceries'],['/events',CalendarHeart,'Activities'],['/photos',Images,'Photos'],['/smoker',Flame,'Smoker HQ'],['/hosting',ClipboardCheck,'Hosting'],['/settings',Settings,'Settings']]
